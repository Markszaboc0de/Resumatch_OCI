...
app.config['SECRET_KEY'] = 'dev-secret-key-change-this-in-prod' # Required for sessions

# Database Configuration (Local PostgreSQL)
# app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://user:password@localhost/dbname"
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://app_user:app_user@localhost:5432/job_match_db" 
